Find a topology on the the set $X = \{a, b, c\}$ such that there exists a disconnected subset $A \subseteq X$ but where there is no separation $U, V$ of $A$ in $X$ such that $U \cap V = \phi$.
